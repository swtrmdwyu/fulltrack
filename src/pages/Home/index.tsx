...
export default function Home() {
  ...
  const [landmarkClient, setLandmarkClient] = useState("");
  ...
  // Lida com as alterações no input de cliente do ponto de referência.
  const handleLandmarkClientChange = (client?:string) => {
    if(!client) {
      return;
    }
  ...
  // Agrupa todos os campos do ponto de referencia em um único objeto.
      ...
      <SideBarContainer>
        ...
        {showRefSideBar && 
          <RefSidebar 
            ...
            onClientChange={handleLandmarkClientChange}
